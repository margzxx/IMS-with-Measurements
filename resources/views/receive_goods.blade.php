    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Receive Goods</div>

                <div class="panel-body">

                    <form action="{{ url('receive-goods') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <h5>Type Quantity Received</h5>
                                <input type="text" name="delivered_qty" placeholder="0" class="form-control" value="{{ $order->qty - $order->delivered_qty }}" min="1">
                            </div>
